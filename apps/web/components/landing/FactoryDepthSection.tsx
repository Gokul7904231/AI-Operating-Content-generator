...
export default function FactoryDepthSection() {
  return (
    <section
      id="architecture"
      className="py-36 lg:py-44 bg-[#f5f5f7] border-t border-[#e8e8ed] select-none relative min-h-[85vh] flex flex-col justify-center"
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-16">
        ...
        {/* High-Level Flow */}
        <div
          className="p-6 sm:p-8 bg-white border border-[#e8e8ed] rounded-2xl font-text text-xs sm:text-sm flex flex-wrap items-center justify-between gap-4 text-[#1d1d1f] shadow-xs apple-card-hover"
          data-reveal
        >
        ...
        {/* Capability Framing: Implemented vs Evolving Roadmap */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10" data-reveal>
          ...
          <div className="bg-white border border-[#e8e8ed] rounded-3xl p-8 sm:p-12 lg:p-14 space-y-6 shadow-sm apple-card-hover">
            <div className="flex items-center justify-between border-b border-[#e8e8ed] pb-3">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-amber-50 border border-amber-200 text-amber-600 font-text text-[10px] font-bold">
                DESIGN & SPEC
              </span>
            </div>
            ...
            <div className="space-y-4 font-text text-xs text-[#1d1d1f]">
              <div className="p-4 bg-[#f5f5f7] border border-[#e8e8ed] rounded-2xl space-y-1.5 shadow-xs">
                <div className="flex justify-between font-bold text-[#1d1d1f]">
                  ...
                  <span className="text-amber-500 font-bold">IN DEVELOPMENT</span>
                </div>
                <p className="text-[11px] text-[#6e6e73] leading-relaxed">
