    ...
    <section className="py-40 lg:py-52 bg-[#f5f5f7] border-t border-[#e8e8ed] select-none relative overflow-hidden flex flex-col justify-center">
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 text-center space-y-10 relative z-10">
        ...
        <div className="flex justify-center pt-4">
          <Link
            href="/login"
            className="px-10 py-5 rounded-2xl bg-[#0071e3] hover:bg-[#0066cc] text-white font-text text-lg font-semibold tracking-wide transition-[transform,background-color] duration-160 ease-out shadow-2xl shadow-sky-500/20 flex items-center gap-3.5 min-h-[60px] active:scale-[0.97]"
          >
