...
import { Play, Pause, Volume2, VolumeX, Film, CheckCircle2 } from "lucide-react";
...
export default function VideoProofSection() {
  ...
  return (
    <section id="proof" className="py-36 lg:py-44 bg-[#f5f5f7] border-t border-[#e8e8ed] select-none relative overflow-hidden min-h-[85vh] flex flex-col justify-center">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-16">
        
        {/* Section Header */}
        <div className="text-center space-y-5 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white border border-[#e8e8ed] text-xs font-text text-[#0071e3] shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="space-y-2">
                <span className="text-xs font-text uppercase text-[#86868b] font-bold tracking-wider">INPUT BRIEF</span>
              ...
              <div className="space-y-2">
                <span className="text-xs font-text uppercase text-[#86868b] font-bold tracking-wider">FACTORY EXECUTION AUDIT</span>
              ...
              <div className="relative w-full max-w-[280px] sm:max-w-[310px] aspect-[9/16] bg-white border border-[#e8e8ed] rounded-2xl p-2 shadow-xl overflow-hidden group">
                <div className="relative w-full h-full rounded-xl overflow-hidden bg-black flex items-center justify-center">
                  ...
                  {!isPlaying && (
                    <button
                      onClick={togglePlay}
                      className="absolute inset-0 bg-black/40 backdrop-blur-xs flex items-center justify-center text-white transition-opacity group-hover:bg-black/30 cursor-pointer"
                    >
                  ...
                  {isPlaying && (
                    <div className="absolute bottom-3 right-3 flex items-center gap-1.5 z-20">
                      <button
                        onClick={togglePlay}
                        className="p-1.5 rounded-md bg-white/90 hover:bg-white text-[#1d1d1f] shadow-sm transition-colors cursor-pointer"
                      >
