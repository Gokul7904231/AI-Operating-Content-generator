  ...
  return (
    <section className="py-32 lg:py-40 bg-[#f5f5f7] border-t border-[#e8e8ed] select-none relative">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-12">
        {/* Section Header */}
        <div
          className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#e8e8ed] pb-8"
          data-reveal
        >
        ...
        {/* Spatial Floor Cards Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4" data-reveal>
          {floors.map((fl) => (
            <div
              key={fl.id}
            ...
            >
              <div>
                ...
                <h3
                  className={`text-sm font-bold font-display tracking-tight ${
                    fl.isConceptual ? "text-[#86868b]" : "text-[#1d1d1f]"
                  }`}
                >
                  {fl.code}
                </h3>
              ...
              <div className="mt-5 pt-3 border-t border-[#f2f2f7]">
                <span
                  className={`inline-block px-2 py-0.5 rounded-full text-[9px] font-bold font-text tracking-wider uppercase border ${
                    fl.isConceptual
