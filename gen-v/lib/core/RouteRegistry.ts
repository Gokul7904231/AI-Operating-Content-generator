...
export const ROUTE_SECTIONS: RouteSection[] = [
  {
    ...
    routes: [
      ...
      { id: "factory-queue",     label: "Queue",      href: "/factory/queue",     section: "Factory", icon: "Loader2",      description: "Live job queue with retry controls",            keywords: ["queue", "pending", "workers"] },
      { id: "factory-scheduler", label: "Scheduler",  href: "/factory/scheduler", section: "Factory", icon: "Calendar",     description: "Schedule recurring content generation jobs",    keywords: ["cron", "schedule", "recurring"] },
      ...
      { id: "factory-workflows", label: "Workflows",  href: "/factory/workflows", section: "Factory", icon: "GitBranch",    description: "DSL workflow manifests — view and edit",        keywords: ["dsl", "workflow", "manifest", "dag"] },
    ],
  },
  {
    id: "engines",
  ...
  },
  {
    ...
    routes: [
      ...
      { id: "ai-runtime",          label: "Runtime",             href: "/ai/runtime",            section: "AI", icon: "Terminal",     description: "Live AI router state and active executions",             keywords: ["runtime", "router", "execution"] },
      { id: "ai-benchmarks",       label: "Benchmarks",          href: "/ai/benchmarks",         section: "AI", icon: "BarChart2",    description: "Provider latency, cost, and quality rankings",           keywords: ["benchmarks", "latency", "cost"] },
      { id: "ai-events",           label: "Event Bus",           href: "/ai/events",             section: "AI", icon: "Activity",     description: "Live EventBus monitor with trace ID filtering",          keywords: ["events", "eventbus", "trace"] },
    ],
  },
  {
    id: "media",
    ...
    routes: [
      ...
      { id: "media-drive",      label: "Google Drive", href: "/media/drive",    section: "Media", icon: "Cloud",     description: "Google Drive sync status and quota",         keywords: ["drive", "google", "storage"] },
      { id: "media-cloudinary", label: "Cloudinary", href: "/media/cloudinary", section: "Media", icon: "HardDrive", description: "Cloudinary usage, folders, and bandwidth",   keywords: ["cloudinary", "cdn", "images"] },
    ],
  },
  {
    id: "publishing",
    ...
    basePath: "/publishing",
    routes: [
      { id: "pub-drive",     label: "Drive Sync",  href: "/publishing/drive",     section: "Publishing", icon: "ArrowUpFromLine", description: "Google Drive upload queue and sync status",  keywords: ["drive", "upload", "sync"] },
  ...
  },
  {
    ...
    basePath: "/dashboard",
    routes: [
      { id: "sre-ai-hospital",  label: "AI Hospital",   href: "/dashboard/ai-hospital",  section: "SRE", icon: "HeartPulse", description: "Full AI infrastructure health center — live diagnostics", keywords: ["hospital", "health", "doctor", "sre", "audit", "diagnostics"] },
      { id: "sre-voice-registry", label: "Voice Registry", href: "/dashboard/voice-registry", section: "SRE", icon: "Mic", description: "Voice capability, health, and benchmarks control center", keywords: ["voice", "tts", "supertonic", "edge", "elevenlabs"] },
      { id: "sre-profiler",     label: "Profiler",      href: "/dashboard/profiler",     section: "SRE", icon: "BarChart2",  description: "Waterfall profiler for every pipeline run",              keywords: ["profiler", "waterfall", "timing"] },
