...
- [ ] **Phase 7: AI Decision Center** — Build AI Explainability Inspector consuming structured evidence objects (`decision`, `reasonCodes`, `evidence`, `gemini-3.6-flash`).
...
- [ ] **Phase 10: Observability & Health Monitoring** — Hardware CPU/Mem load, SRE telemetry, and SQLite metrics inspection.
- [ ] **Phase 11: Analytics & Reporting** — Real provider latency, model cost (`gemini-3.6-flash`), and render speed metrics.
...
- [ ] **Phase 14: End-to-End QA & Chaos Testing** — Integration testing & process failure recovery (`factoryos/tests/auth.test.ts`).
